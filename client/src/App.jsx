...
import { mockState } from "./../src/Components/Metrics/mockData/tableData.js";
...
class App extends React.Component {
  ...
  getTodos(id = this.state.user.id) {
    axios
      ...
      .catch((err) => console.error("Error in axios getTodos()", err));
  }
  ...
  getCategories(id = this.state.user.id) {
    axios
      ...
      .catch((err) => console.error("Error in axios getCategories()", err));
  }
  ...
  handleTodoSubmit() {
    axios
      ...
      .catch((err) => console.error("Error in axios handleTodoSubmit()", err));
  }
  ...
  plannedToDo(i) {
    ...
    let newUnplanned = [
      ...this.state.unplannedEvents.slice(0, index),
  ...
  handleAddCategorySubmit() {
    ...
    axios
      ...
      .catch((err) =>
        console.error("Error in axios handleAddCategorySubmit()", err)
      );
  }
  loginToggel(event) {
    this.setState({
  ...
  updateCompleted() {
    axios
      ...
      .catch((err) => console.error("Error in axios updateCompleted()", err));
  }
    ...
    return (
      <>
                ...
                element={
                  <>
                    <SignOut
                      ...
                      signOutClick={this.handleSignOutUser}
                    />
                  </>
                }
              ></Route>
        ...
        {!status && (
          <Landing
            userId={this.state.user.id}
            signInClick={this.handleSignInUser}
            signUpClick={this.handleSignUpUser}
          />
        )}
      </>
    );
